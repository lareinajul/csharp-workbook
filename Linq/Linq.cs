...
namespace StudentList
{
	public class Program
	{
        ...
        GetStudentName_NegativeBalance(students);
		}

        static void GetStudentName_NegativeBalance(List<Student> students)
        {
            var resultSet =
            ...
            foreach(Student student in resultSet)
            {
                Console.WriteLine($"Student {student.Name} has a negative balance of {student.Balance}");
            }
        }
	}
