...
namespace StarWars
{
    public class Program
    {
        public static void Main()
        {
            ...
            rebel.EnterStation(falcon, 0);
            wing.EnterShip(darth,2);
            rebel.EnterStation(wing,4);

            var rebelRoster = rebel.Roster;
            Console.WriteLine(rebelRoster);
            Console.ReadLine();
    ...
    public class Station
    {
        ...
        public string Ships
        {
            get
            {
                ...
                {
                    Console.WriteLine(String.Format("{0}", ship.));
                }
