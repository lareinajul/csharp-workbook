...
public class Workflow
{
    ...
    public Workflow()
    {
        _activities = new List<IActivity>
        {
            ...
            { new MySportActivity{Message = "CrossCountry..." } },
            { new MySportActivity{Message = "Gymnastics..." } },
            { new MySportActivity{Message = "TaeKwonDo..." } },
            { new MySportActivity{Message = "Track..." } },
        };
    }
...
public class MySportActivity : IActivity
{
    public string Message { get; set; }

    public void Execute()
    {
        Console.WriteLine("Performing My Sport Activity: {0}", Message);
    }
}
